Using this data (https://www.kaggle.com/anthonypino/melbourne-housing-market) to create a model (Linear Regression) to predict a house's value. We want to be able to understand what creates value
